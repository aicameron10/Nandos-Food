...
public class CustomListAdapterOrder extends BaseAdapter implements OnClickListener {
    ...
    public CustomListAdapterOrder(Activity activity, List<Notification> listItems) {
